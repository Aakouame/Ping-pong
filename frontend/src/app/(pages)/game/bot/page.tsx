...
import ProfileImgBot from "@/app/assets/svg/game/withBot.svg";
            ...
            <div className="flex justify-center">
              <div className="flex flex-col justify-center items-center">
                <Image
                  ...
                  src={dataSettings.photo_path === 'default_img' ? `${DefaultImg.src}`: dataSettings.photo_path}
                  width={20}
                  height={20}
                  alt="profile pic"
                />
