            ...
            <table className="w-full">
              ...
              <tbody>
                {dataGamesHistory.map((data) => {
                  const Isimage = data.opponent_data.photo_path === 'default_img' ? `${DefaultImg.src}` : data.opponent_data.photo_path;
                  ...
                  return (
                    <tr key={data.id} className="text-center even:bg-[#0C0914] ">
                      ...
                      >
                        <Image
                          draggable={false}
                          className="sm:w-[20px] sm:h-[20px] md:w-[30px] md:h-[30px] lg:w-[36px] lg:h-[36px] xl:w-10 xl:h-10 2xl:w-14 2xl:h-14 rounded-full"
                          src={Isimage}
                          width={15}
                          height={15}
                          alt="img of a user"
